...
import { Generator, StaticDocumentationData, Utils } from "@ts-docs/ts-docs";

export function render(gen: Generator, staticData: StaticDocumentationData, type: Utils.ChangelogData) {
    return <div>
        <h1>Changelog</h1>
