...
function generateExternalLink(name: string, redirect: string) : string {
    return <a href={redirect} target="_blank">
                ...
                if (isCurrentPageHere) {
                    sidebarCategories.unshift({
                        ...
                        values: category.pages.map(p => {
                            ...
                            else if (p.attributes.redirect) return generateExternalLink(p.name, p.attributes.redirect);
