...
var Themes = {
    dark: {
        ...
        highlightTheme: "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.2.0/styles/atom-one-dark.min.css"
    },
    light: {
        ...
        highlightTheme: "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.2.0/styles/atom-one-light.min.css"
    }
};
var currentTheme;
function setTheme(themeName, saveChoice, icon, highlightTheme) {
...
function initTheme() {
    ...
    window.addEventListener("load", function () {
        ...
        var highlightTheme = document.getElementById("highlightTheme");
        icon.innerHTML = Themes[oppositeOfCurrentTheme()].icon;
        highlightTheme.href = Themes[currentTheme].highlightTheme;
        icon.onclick = function () { return setTheme(oppositeOfCurrentTheme(), true, icon, highlightTheme); };
    });
}
