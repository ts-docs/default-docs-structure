...
const Themes: Record<string, {icon: string, highlightTheme: string}> = {
    dark: {
...
function setTheme(themeName: string, saveChoice?: boolean, icon?: HTMLElement, highlightTheme?: HTMLLinkElement) {
